...
async function main() {
  ...
  // Show all recent notifications (last 15)
  ...
  recent.forEach(function(n) {
    console.log('  [' + n.createdAt.toISOString() + '] ' + n.kind + ' | user:' + n.userId + ' | ' + n.message.substring(0,70) + ' | read:' + (n.readAt ? n.readAt.toISOString() : 'NULL'));
  });
